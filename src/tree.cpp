...
namespace ecrp {
    ...
    class node {
        ...
        public: // METHODS
            ...
            void findPoints(tree &holder, vector<full_point> &output, size_t limit, uint32_t minLat, uint32_t minLon, uint32_t maxLat, uint32_t maxLon) {
    ...
    void tree::findPoints(vector<full_point> &output, size_t limit, uint32_t minLat, uint32_t minLon, uint32_t maxLat, uint32_t maxLon) {
